...
export WANDB_RUN_ID="vso2a3e7"
export HYDRA_FULL_ERROR=1
export WANDB_RESUME='must'

experiment_name="qwen3-8b-grpohistbeta-paper-batch128-cliph1_0-clipl1_0-clipc10-nokl-lr1e-6-df0_25"
...
python3 -m verl.trainer.main_ppo \
    ...
    algorithm.history.beta_discount=0.25 \
