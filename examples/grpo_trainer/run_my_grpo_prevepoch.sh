...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='verl_grpo_qwen2_5_1_5b_MATH_1' \
    trainer.experiment_name='grpo-prev-epoch-2-8-v1-fsdp2' \
    trainer.n_gpus_per_node=4 \
    trainer.nnodes=1 \
    trainer.save_freq=10 \
    trainer.default_local_dir='/workspace/GRPO/models/verl_grpo_prev_epoch_qwen2_5_1_5b_MATH_1' \
