...
export WANDB_RUN_ID="lfwfxf42"
export HYDRA_FULL_ERROR=1
export WANDB_RESUME='must'

experiment_name="qwen3-8b-grpo-paper-batch128-cliph0_28-clipl0_2-clipc3-nokl-lr1e-6-again"
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.max_num_batched_tokens=$(((1024 + 8192) * 8)) \
