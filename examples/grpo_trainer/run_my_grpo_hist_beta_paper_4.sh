...
# export WANDB_RUN_ID="42x4ce9e"
export HYDRA_FULL_ERROR=1
# export WANDB_RESUME='must'

experiment_name="qwen3-grpohistbeta-paper-batch128-cliph1_0-clipl1_0-clipc10-nokl-lr1e-6-df0_25_1_00"
...
python3 -m verl.trainer.main_ppo \
    ...
    algorithm.history.alpha_discount=0.25 \
    algorithm.history.beta_discount=1.0 \
