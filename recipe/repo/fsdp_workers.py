...
class RePORolloutRefWorker(Worker, DistProfilerExtension):
    """
    ...
    def init_model(self):
        from recipe.repo.dp_actor import RePODataParallelPPOActor as DataParallelPPOActor
...
class AsyncActorRolloutRefWorker(RePORolloutRefWorker):
    def _build_rollout(self, trust_remote_code=False):
