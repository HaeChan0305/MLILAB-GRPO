...
class GRPOHistBetaRolloutRefWorker(Worker, DistProfilerExtension):
    """
    ...
    def init_model(self):
        from recipe.grpohistbeta.dp_actor import GRPOHistBetaDataParallelPPOActor as DataParallelPPOActor
...
class AsyncActorRolloutRefWorker(GRPOHistBetaRolloutRefWorker):
    def _build_rollout(self, trust_remote_code=False):
